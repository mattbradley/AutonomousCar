...
{
    /// <summary>
    /// The Experiment class is the base class for all experiments.
    /// Experiments can be used to auto-run missions with different parameters while collecting statistics on path finding or path following performance.
    /// </summary>
    ...
    /// <summary>
    /// The SmootherExperiment class runs an experiment that tests the vehicle's performance on smooth and unsmooth paths.
    /// </summary>
    public class SmootherExperiment : Experiment
    {
        ...
        private void startSim()
        {
            ...
            simulation.InitSim(true, smoothing, @"../../../missions/default.json");
        }
    }

    /// <summary>
    /// The ParkingExperiment class runs an experiment that tests the vehicle's goal pose accuracy.
    /// </summary>
